...
def load_EOD_data(data_path, market_name, tickers, steps=1):
    ...
    for index, ticker in enumerate(tickers):
        ...
        if market_name == 'NASDAQ':
            # remove the last day since lots of missing data(将最后一行切片)
        ...
        moving_matrix=np.load('../data/'+market_name+'moving_matrix.npy')
    return eod_data, masks, ground_truth, base_price,moving_matrix
